...
if (d.atomIndex2 == this.index) {
d.atomIndex2 = c.index;
} else {
d.atomIndex1 = c.index;
}}
});
...
function () {
return Clazz.superCall (this, J.adapter.readers.xml.XmlChemDrawReader.CDBond, "toString", []) + " id1=" + this.id1 + " id2=" + this.id2;
});
c$ = Clazz.p0p ();
};
});
