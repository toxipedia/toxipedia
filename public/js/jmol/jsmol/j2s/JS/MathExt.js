...
if (asBytes) return mp.addXMap (this.vwr.fm.getFileAsMap (file, null, false));
...
bsAtoms = this.vwr.getModelUndeletedAtomsBitSet (this.vwr.getModelForAtomIndex (bsAtoms.nextSetBit (0)).modelIndex);
}break;
}
